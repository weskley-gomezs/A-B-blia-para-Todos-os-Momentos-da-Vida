...
export const PRODUCT_INFO = {
  ...
  subtitle: "100 Estudos Bíblicos Práticos para fortalecer sua fé e aplicar a Palavra de Deus no dia a dia.",
  price: "R$ 37,90",
  originalPrice: "R$ 97,00",
  format: "eBook PDF",
  delivery: "Entrega imediata via e-mail após a confirmação do pagamento.",
  guaranteeDays: 7,
};
